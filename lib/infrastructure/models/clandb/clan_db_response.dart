class ClanDBResponse {
  ...
  factory ClanDBResponse.fromJson(Map<String, dynamic> json) {
    return ClanDBResponse(
...
class Label {
  ...
  factory Label.fromJson(Map<String, dynamic> json) => Label(
        ...
        iconUrls: json["iconUrls"] != null
            ? IconUrls.fromJson(json["iconUrls"] as Map<String, dynamic>)
            : IconUrls(small: '', medium: ''),
      );
...
class MemberList {
  ...
  factory MemberList.fromJson(Map<String, dynamic> json) => MemberList(
        ...
        league: json["league"] != null
            ...
            : LeagueClass(id: 0, name: '', iconUrls: LeagueIconUrls(small: '', tiny: '', medium: '')),
